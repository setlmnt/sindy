<template>
    <nav class=" w-24 flex flex-col justify-between p-2 bg-neutral">
        <div>
            <img src="" alt="">
        </div>
        ...
        <label class="swap swap-rotate w-">
            ...
            <svg class="swap-off fill-white w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path
