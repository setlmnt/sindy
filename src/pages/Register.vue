          ...
          <div>
            <div class="label">
              ...
              <label class="btn btn-ghost w-10 h-10 swap swap-rotate label-text-alt">
                ...
                <svg class="swap-off fill-current w-6 h-6" xmlns="http://www.w3.org/2000/svg" height="24"
                  viewBox="0 -960 960 960" width="24">
                  <path
            ...
            <input class="input focus:input-primary w-full placeholder-white/25"
              :type="passwordVisible ? 'text' : 'password'" placeholder="Informe sua senha" id="password"
